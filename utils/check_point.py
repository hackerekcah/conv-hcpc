...
class CheckPoint (object):
    ...
    def __init__(self, model=None, optimizer=None, path=None, prefix='',
                 interval=5, save_num=3, verbose=True,
                 fake_save=True):
    ...
    def _get_save_path(self, epoch, monitor, loss_acc):
        ...
        if self.fake_save:
            full_path = os.path.join(self.path, '{},{},Epoch_{},{}_{:.6f}.fake'.format(
